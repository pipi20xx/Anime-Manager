...
from routers import (
    ...
    system, clients, rss, subscriptions, tmdb, bangumi, webhook, tmdb_full, explore, priority, calendar, auth, health, user_mapping, task_history, assistant, sytmdb, file_hashes, appearance, tmdb_blocklist
)
