...
.small-no-poster { width: 80px; height: 120px; background: #111; display: flex; align-items: center; justify-content: center; font-size: 10px; color: #333; border-radius: 4px; border: 1px dashed #222; }
...
.tmdb-meta-line { font-size: 11px; color: #555; display: flex; gap: 12px; margin-bottom: 8px; }
.tmdb-id-badge { font-family: monospace; opacity: 0.8; }
.tmdb-overview-box { background: rgba(0,0,0,0.2); padding: 8px; border-radius: 4px; flex-grow: 1; }
.overview-text { font-size: 12px; color: #888; line-height: 1.5; display: -webkit-box; -webkit-line-clamp: 4; -webkit-box-orient: vertical; overflow: hidden; font-style: italic; }
</style>