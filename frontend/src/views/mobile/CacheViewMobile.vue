      ...
      <div style="overflow-y: auto; max-height: calc(90vh - 120px); padding-right: 4px;">
        <n-form label-placement="top">
          <n-form-item label="TMDB ID">
            <n-input v-model:value="editForm.id" placeholder="数字 ID" :disabled="isEditing" />
          </n-form-item>
          ...
          <n-form-item label="原始标题">
            <n-input v-model:value="editForm.original_title" />
          </n-form-item>
          <n-form-item label="分类名称">
            <n-input v-model:value="editForm.category" placeholder="电影 / 剧集" />
          </n-form-item>
          <n-form-item label="发行年份">
            <n-input v-model:value="editForm.year" placeholder="YYYY" />
          </n-form-item>
          <n-form-item label="播出日期">
            <n-input v-model:value="editForm.release_date" placeholder="YYYY-MM-DD" />
          </n-form-item>
          <n-form-item label="海报链接">
            <n-input v-model:value="editForm.poster_path" />
          </n-form-item>
          <n-form-item label="内容简介">
            <n-input v-model:value="editForm.overview" type="textarea" :autosize="{minRows:3, maxRows: 6}" />
          </n-form-item>
        </n-form>
      </div>
      <template #action>
